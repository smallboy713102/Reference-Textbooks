...
fundamental package for scientific computing Python. -
\href{http://matplotlib.org}{matplotlib} is a popular library to plot
graphs in Python. - \href{https://scikit-learn.org/stable/}{scikitlearn}
is a basic library for data mining -
\href{https://www.tensorflow.org/}{tensorflow} a popular platform for
machine learning.
...
\PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{linear\PYZus{}model} \PY{k+kn}{import} \PY{n}{LinearRegression}\PY{p}{,} \PY{n}{Ridge}
\PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{preprocessing} \PY{k+kn}{import} \PY{n}{StandardScaler}\PY{p}{,} \PY{n}{PolynomialFeatures}
...
\PY{k+kn}{from} \PY{n+nn}{tensorflow}\PY{n+nn}{.}\PY{n+nn}{keras}\PY{n+nn}{.}\PY{n+nn}{activations} \PY{k+kn}{import} \PY{n}{relu}\PY{p}{,}\PY{n}{linear}
\PY{k+kn}{from} \PY{n+nn}{tensorflow}\PY{n+nn}{.}\PY{n+nn}{keras}\PY{n+nn}{.}\PY{n+nn}{losses} \PY{k+kn}{import} \PY{n}{SparseCategoricalCrossentropy}
...
\PY{k+kn}{from} \PY{n+nn}{public\PYZus{}tests\PYZus{}a1} \PY{k+kn}{import} \PY{o}{*} 
...
\PY{k+kn}{from} \PY{n+nn}{assigment\PYZus{}utils} \PY{k+kn}{import} \PY{o}{*}
...
Let's say you have created a machine learning model and you find it
\emph{fits} your training data very well. You're done? Not quite. The
goal of creating the model was to be able to predict values for
{\emph{new} } examples.

How can you test your model's performance on new data before deploying
it?\\
The answer has two parts: * Split your original data set into
``Training'' and ``Test'' sets. * Use the training data to fit the
parameters of the model * Use the test data to evaluate the model on
\emph{new} data * Develop an error function to evaluate your model.

    \#\#\# 2.1 Splitting your data set Lectures advised reserving 20-40\% of
your data set for testing. Let's use an \texttt{sklearn} function
\href{https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.train_test_split.html}{train\_test\_split}
to perform the split. Double-check the shapes after running the
following cell.
...
\PY{n}{X}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{x\PYZus{}ideal}\PY{p}{,}\PY{n}{y\PYZus{}ideal} \PY{o}{=} \PY{n}{gen\PYZus{}data}\PY{p}{(}\PY{l+m+mi}{18}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mf}{0.7}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y}\PY{o}{.}\PY{n}{shape}\PY{p}{)}

\PY{c+c1}{\PYZsh{}split the data using sklearn routine }
\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}test} \PY{o}{=} \PY{n}{train\PYZus{}test\PYZus{}split}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{test\PYZus{}size}\PY{o}{=}\PY{l+m+mf}{0.33}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X\PYZus{}train.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y\PYZus{}train.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X\PYZus{}test.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y\PYZus{}test.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
X.shape (18,) y.shape (18,)
X\_train.shape (12,) y\_train.shape (12,)
X\_test.shape (6,) y\_test.shape (6,)
    \end{Verbatim}

    \hypertarget{plot-train-test-sets}{%
\paragraph{2.1.1 Plot Train, Test sets}\label{plot-train-test-sets}}

You can see below the data points that will be part of training (in red)
are intermixed with those that the model is not trained on (test). This
particular data set is a quadratic function with noise added. The
``ideal'' curve is shown for reference.
...
\PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x\PYZus{}ideal}\PY{p}{,} \PY{n}{y\PYZus{}ideal}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{orangered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y\PYZus{}ideal}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{lw}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Training, Test}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{fontsize} \PY{o}{=} \PY{l+m+mi}{14}\PY{p}{)}
...
\PY{n}{ax}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{red}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}           \PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{train}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{,}   \PY{n}{color} \PY{o}{=} \PY{n}{dlc}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dlblue}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}   \PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
When \emph{evaluating} a linear regression model, you average the
squared error difference of the predicted values and the target values.
...
Below, create a function to evaluate the error on a data set for a
...
\PY{c+c1}{\PYZsh{} GRADED CELL: eval\PYZus{}mse}
\PY{k}{def} \PY{n+nf}{eval\PYZus{}mse}\PY{p}{(}\PY{n}{y}\PY{p}{,} \PY{n}{yhat}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} }
\PY{l+s+sd}{    Calculate the mean squared error on a data set.}
\PY{l+s+sd}{    Args:}
\PY{l+s+sd}{      y    : (ndarray  Shape (m,) or (m,1))  target value of each example}
\PY{l+s+sd}{      yhat : (ndarray  Shape (m,) or (m,1))  predicted value of each example}
\PY{l+s+sd}{    Returns:}
\PY{l+s+sd}{      err: (scalar)             }
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{m} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{y}\PY{p}{)}
    \PY{n}{err} \PY{o}{=} \PY{l+m+mf}{0.0}
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
    \PY{n}{err} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{p}{(}\PY{n}{yhat} \PY{o}{\PYZhy{}} \PY{n}{y}\PY{p}{)}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{m}\PY{p}{)} 
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
    
    \PY{k}{return}\PY{p}{(}\PY{n}{err}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{y\PYZus{}hat} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{2.4}\PY{p}{,} \PY{l+m+mf}{4.2}\PY{p}{]}\PY{p}{)}
\PY{n}{y\PYZus{}tmp} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{2.3}\PY{p}{,} \PY{l+m+mf}{4.1}\PY{p}{]}\PY{p}{)}
\PY{n}{eval\PYZus{}mse}\PY{p}{(}\PY{n}{y\PYZus{}hat}\PY{p}{,} \PY{n}{y\PYZus{}tmp}\PY{p}{)}

\PY{c+c1}{\PYZsh{} BEGIN UNIT TEST}
\PY{n}{test\PYZus{}eval\PYZus{}mse}\PY{p}{(}\PY{n}{eval\PYZus{}mse}\PY{p}{)}   
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{def}\NormalTok{ eval\_mse(y, yhat):}
    \CommentTok{""" }
\CommentTok{    Calculate the mean squared error on a data set.}
\CommentTok{    Args:}
...
\CommentTok{    Returns:}
\CommentTok{      err: (scalar)             }
\CommentTok{    """}
\NormalTok{    m }\OperatorTok{=} \BuiltInTok{len}\NormalTok{(y)}
\NormalTok{    err }\OperatorTok{=} \FloatTok{0.0}
    \ControlFlowTok{for}\NormalTok{ i }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(m):}
\NormalTok{        err\_i  }\OperatorTok{=}\NormalTok{ ( (yhat[i] }\OperatorTok{{-}}\NormalTok{ y[i])}\OperatorTok{**}\DecValTok{2}\NormalTok{ ) }
\NormalTok{        err   }\OperatorTok{+=}\NormalTok{ err\_i                                                                }
\NormalTok{    err }\OperatorTok{=}\NormalTok{ err }\OperatorTok{/}\NormalTok{ (}\DecValTok{2}\OperatorTok{*}\NormalTok{m)                    }
    \ControlFlowTok{return}\NormalTok{(err)}
\end{Highlighting}
\end{Shaded}

    \#\#\# 2.3 Compare performance on training and test data Let's build a
high degree polynomial model to minimize training error. This will use
the linear\_regression functions from \texttt{sklearn}. The code is in
the imported utility file if you would like to see the details. The
steps below are: * create and fit the model. (`fit' is another name for
training or running gradient descent). * compute the error on the
training data. * compute the error on the test data.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{6}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} create a model in sklearn, train on training data}
\PY{n}{degree} \PY{o}{=} \PY{l+m+mi}{10}
\PY{n}{lmodel} \PY{o}{=} \PY{n}{lin\PYZus{}model}\PY{p}{(}\PY{n}{degree}\PY{p}{)}
\PY{n}{lmodel}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}

\PY{c+c1}{\PYZsh{} predict on training data, find training error}
\PY{n}{yhat} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
\PY{n}{err\PYZus{}train} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{mse}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{yhat}\PY{p}{)}

\PY{c+c1}{\PYZsh{} predict on test data, find error}
\PY{n}{yhat} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{)}
\PY{n}{err\PYZus{}test} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{mse}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{yhat}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    The computed error on the training set is substantially less than that
of the test set.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{7}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{training err }\PY{l+s+si}{\PYZob{}}\PY{n}{err\PYZus{}train}\PY{l+s+si}{:}\PY{l+s+s2}{0.2f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, test err }\PY{l+s+si}{\PYZob{}}\PY{n}{err\PYZus{}test}\PY{l+s+si}{:}\PY{l+s+s2}{0.2f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
training err 58.01, test err 171215.01
    ...
    The following plot shows why this is. The model fits the training data
very well. To do so, it has created a complex function. The test data
was not part of the training and the model does a poor job of predicting
on this data.\\
This model would be described as 1) is overfitting, 2) has high variance
3) `generalizes' poorly.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{8}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} plot predictions over data range }
\PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{)}  \PY{c+c1}{\PYZsh{} predict values for plot}
\PY{n}{y\PYZus{}pred} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}

\PY{n}{plt\PYZus{}train\PYZus{}test}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{y\PYZus{}pred}\PY{p}{,} \PY{n}{x\PYZus{}ideal}\PY{p}{,} \PY{n}{y\PYZus{}ideal}\PY{p}{,} \PY{n}{degree}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Canvas(toolbar=Toolbar(toolitems=[('Home', 'Reset original view', 'home', 'home'), ('Back', 'Back to previous …
    ...
    The test set error shows this model will not work well on new data. If
you use the test error to guide improvements in the model, then the
model will perform well on the test data\ldots{} but the test data was
meant to represent \emph{new} data. You need yet another set of data to
test new data performance.
...
Let's generate three data sets below. We'll once again use
\texttt{train\_test\_split} from \texttt{sklearn} but will call it twice
to get three splits:
...
\PY{n}{X}\PY{p}{,}\PY{n}{y}\PY{p}{,} \PY{n}{x\PYZus{}ideal}\PY{p}{,}\PY{n}{y\PYZus{}ideal} \PY{o}{=} \PY{n}{gen\PYZus{}data}\PY{p}{(}\PY{l+m+mi}{40}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mf}{0.7}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y}\PY{o}{.}\PY{n}{shape}\PY{p}{)}

\PY{c+c1}{\PYZsh{}split the data using sklearn routine }
\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}} \PY{o}{=} \PY{n}{train\PYZus{}test\PYZus{}split}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{test\PYZus{}size}\PY{o}{=}\PY{l+m+mf}{0.40}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}test} \PY{o}{=} \PY{n}{train\PYZus{}test\PYZus{}split}\PY{p}{(}\PY{n}{X\PYZus{}}\PY{p}{,}\PY{n}{y\PYZus{}}\PY{p}{,}\PY{n}{test\PYZus{}size}\PY{o}{=}\PY{l+m+mf}{0.50}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X\PYZus{}train.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y\PYZus{}train.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X\PYZus{}cv.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y\PYZus{}cv.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X\PYZus{}test.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y\PYZus{}test.shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{fig}\PY{p}{,} \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x\PYZus{}ideal}\PY{p}{,} \PY{n}{y\PYZus{}ideal}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{orangered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y\PYZus{}ideal}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{lw}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Training, CV, Test}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{fontsize} \PY{o}{=} \PY{l+m+mi}{14}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{x}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{n}{ax}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{red}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}           \PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{train}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,}       \PY{n}{color} \PY{o}{=} \PY{n}{dlc}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dlorange}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{cv}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{,}   \PY{n}{color} \PY{o}{=} \PY{n}{dlc}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dlblue}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}   \PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{n}{loc}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{upper left}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{max\PYZus{}degree} \PY{o}{=} \PY{l+m+mi}{9}
\PY{n}{err\PYZus{}train} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{max\PYZus{}degree}\PY{p}{)}    
\PY{n}{err\PYZus{}cv} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{max\PYZus{}degree}\PY{p}{)}      
\PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{)}  
\PY{n}{y\PYZus{}pred} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{,}\PY{n}{max\PYZus{}degree}\PY{p}{)}\PY{p}{)}  \PY{c+c1}{\PYZsh{}columns are lines to plot}

\PY{k}{for} \PY{n}{degree} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{max\PYZus{}degree}\PY{p}{)}\PY{p}{:}
    \PY{n}{lmodel} \PY{o}{=} \PY{n}{lin\PYZus{}model}\PY{p}{(}\PY{n}{degree}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}
    \PY{n}{lmodel}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}
    \PY{n}{yhat} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
    \PY{n}{err\PYZus{}train}\PY{p}{[}\PY{n}{degree}\PY{p}{]} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{mse}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{yhat}\PY{p}{)}
    \PY{n}{yhat} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}cv}\PY{p}{)}
    \PY{n}{err\PYZus{}cv}\PY{p}{[}\PY{n}{degree}\PY{p}{]} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{mse}\PY{p}{(}\PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{yhat}\PY{p}{)}
    \PY{n}{y\PYZus{}pred}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{degree}\PY{p}{]} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{x}\PY{p}{)}
    
\PY{n}{optimal\PYZus{}degree} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{argmin}\PY{p}{(}\PY{n}{err\PYZus{}cv}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{1}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{plt\PYZus{}optimal\PYZus{}degree}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{y\PYZus{}pred}\PY{p}{,} \PY{n}{x\PYZus{}ideal}\PY{p}{,} \PY{n}{y\PYZus{}ideal}\PY{p}{,} 
                   \PY{n}{err\PYZus{}train}\PY{p}{,} \PY{n}{err\PYZus{}cv}\PY{p}{,} \PY{n}{optimal\PYZus{}degree}\PY{p}{,} \PY{n}{max\PYZus{}degree}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Canvas(toolbar=Toolbar(toolitems=[('Home', 'Reset original view', 'home', 'home'), ('Back', 'Back to previous …
    ...
    The plot above demonstrates that separating data into two groups, data
the model is trained on and data the model has not been trained on, can
be used to determine if the model is underfitting or overfitting. In our
example, we created a variety of models varying from underfitting to
overfitting by increasing the degree of the polynomial used. - On the
left plot, the solid lines represent the predictions from these models.
A polynomial model with degree 1 produces a straight line that
intersects very few data points, while the maximum degree hews very
closely to every data point. - on the right: - the error on the trained
data (blue) decreases as the model complexity increases as expected -
the error of the cross-validation data decreases initially as the model
starts to conform to the data, but then increases as the model starts to
over-fit on the training data (fails to \emph{generalize}).

It's worth noting that the curves in these examples as not as smooth as
one might draw for a lecture. It's clear the specific data points
assigned to each group can change your results significantly. The
general trend is what is important.

    \#\#\# 3.3 Tuning Regularization. In previous labs, you have utilized
\emph{regularization} to reduce overfitting. Similar to degree, one can
use the same methodology to tune the regularization parameter lambda
(\(\lambda\)).

Let's demonstrate this by starting with a high degree polynomial and
varying the regularization parameter.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{13}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{lambda\PYZus{}range} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{1e\PYZhy{}6}\PY{p}{,} \PY{l+m+mf}{1e\PYZhy{}5}\PY{p}{,} \PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{,}\PY{l+m+mf}{1e\PYZhy{}3}\PY{p}{,}\PY{l+m+mf}{1e\PYZhy{}2}\PY{p}{,} \PY{l+m+mf}{1e\PYZhy{}1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{]}\PY{p}{)}
\PY{n}{num\PYZus{}steps} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{lambda\PYZus{}range}\PY{p}{)}
\PY{n}{degree} \PY{o}{=} \PY{l+m+mi}{10}
\PY{n}{err\PYZus{}train} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{num\PYZus{}steps}\PY{p}{)}    
\PY{n}{err\PYZus{}cv} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{num\PYZus{}steps}\PY{p}{)}       
\PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{X}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{)} 
\PY{n}{y\PYZus{}pred} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{,}\PY{n}{num\PYZus{}steps}\PY{p}{)}\PY{p}{)}  \PY{c+c1}{\PYZsh{}columns are lines to plot}

\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}steps}\PY{p}{)}\PY{p}{:}
    \PY{n}{lambda\PYZus{}}\PY{o}{=} \PY{n}{lambda\PYZus{}range}\PY{p}{[}\PY{n}{i}\PY{p}{]}
    \PY{n}{lmodel} \PY{o}{=} \PY{n}{lin\PYZus{}model}\PY{p}{(}\PY{n}{degree}\PY{p}{,} \PY{n}{regularization}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{lambda\PYZus{}}\PY{o}{=}\PY{n}{lambda\PYZus{}}\PY{p}{)}
    \PY{n}{lmodel}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}
    \PY{n}{yhat} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
    \PY{n}{err\PYZus{}train}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{mse}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{yhat}\PY{p}{)}
    \PY{n}{yhat} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{X\PYZus{}cv}\PY{p}{)}
    \PY{n}{err\PYZus{}cv}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{mse}\PY{p}{(}\PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{yhat}\PY{p}{)}
    \PY{n}{y\PYZus{}pred}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{lmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{x}\PY{p}{)}
    
\PY{n}{optimal\PYZus{}reg\PYZus{}idx} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{argmin}\PY{p}{(}\PY{n}{err\PYZus{}cv}\PY{p}{)} 
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{plt}\PY{o}{.}\PY{n}{close}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{all}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{plt\PYZus{}tune\PYZus{}regularization}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{y\PYZus{}pred}\PY{p}{,} \PY{n}{err\PYZus{}train}\PY{p}{,} \PY{n}{err\PYZus{}cv}\PY{p}{,} \PY{n}{optimal\PYZus{}reg\PYZus{}idx}\PY{p}{,} \PY{n}{lambda\PYZus{}range}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Canvas(toolbar=Toolbar(toolitems=[('Home', 'Reset original view', 'home', 'home'), ('Back', 'Back to previous …
    ...
    Above, the plots show that as regularization increases, the model moves
from a high variance (overfitting) model to a high bias (underfitting)
model. The vertical line in the right plot shows the optimal value of
lambda. In this example, the polynomial degree was set to 10.

    \#\#\# 3.4 Getting more data: Increasing Training Set Size (m) When a
model is overfitting (high variance), collecting additional data can
improve performance. Let's try that here.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{15}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{y\PYZus{}pred}\PY{p}{,} \PY{n}{err\PYZus{}train}\PY{p}{,} \PY{n}{err\PYZus{}cv}\PY{p}{,} \PY{n}{m\PYZus{}range}\PY{p}{,}\PY{n}{degree} \PY{o}{=} \PY{n}{tune\PYZus{}m}\PY{p}{(}\PY{p}{)}
\PY{n}{plt\PYZus{}tune\PYZus{}m}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{y\PYZus{}pred}\PY{p}{,} \PY{n}{err\PYZus{}train}\PY{p}{,} \PY{n}{err\PYZus{}cv}\PY{p}{,} \PY{n}{m\PYZus{}range}\PY{p}{,} \PY{n}{degree}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Generate and split data set}
\PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{centers}\PY{p}{,} \PY{n}{classes}\PY{p}{,} \PY{n}{std} \PY{o}{=} \PY{n}{gen\PYZus{}blobs}\PY{p}{(}\PY{p}{)}

\PY{c+c1}{\PYZsh{} split the data. Large CV population for demonstration}
\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}} \PY{o}{=} \PY{n}{train\PYZus{}test\PYZus{}split}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{test\PYZus{}size}\PY{o}{=}\PY{l+m+mf}{0.50}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}test} \PY{o}{=} \PY{n}{train\PYZus{}test\PYZus{}split}\PY{p}{(}\PY{n}{X\PYZus{}}\PY{p}{,}\PY{n}{y\PYZus{}}\PY{p}{,}\PY{n}{test\PYZus{}size}\PY{o}{=}\PY{l+m+mf}{0.20}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X\PYZus{}train.shape:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X\PYZus{}cv.shape:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{o}{.}\PY{n}{shape}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{X\PYZus{}test.shape:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
X\_train.shape: (400, 2) X\_cv.shape: (320, 2) X\_test.shape: (80, 2)
    \end{Verbatim}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{17}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{plt\PYZus{}train\PYZus{}eq\PYZus{}dist}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,}\PY{n}{classes}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{centers}\PY{p}{,} \PY{n}{std}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{c+c1}{\PYZsh{} GRADED CELL: eval\PYZus{}cat\PYZus{}err}
\PY{k}{def} \PY{n+nf}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y}\PY{p}{,} \PY{n}{yhat}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} }
\PY{l+s+sd}{    Calculate the categorization error}
\PY{l+s+sd}{    Args:}
\PY{l+s+sd}{      y    : (ndarray  Shape (m,) or (m,1))  target value of each example}
\PY{l+s+sd}{      yhat : (ndarray  Shape (m,) or (m,1))  predicted value of each example}
\PY{l+s+sd}{    Returns:|}
\PY{l+s+sd}{      cerr: (scalar)             }
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{m} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{y}\PY{p}{)}
    \PY{n}{incorrect} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
    \PY{n}{cerr} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{i}\PY{p}{)} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{p}{(}\PY{n}{yhat} \PY{o}{!=} \PY{n}{y}\PY{p}{)}\PY{p}{)} \PY{o}{/} \PY{n}{m}
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
    
    \PY{k}{return}\PY{p}{(}\PY{n}{cerr}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{y\PYZus{}hat} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
\PY{n}{y\PYZus{}tmp} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{categorization error }\PY{l+s+si}{\PYZob{}}\PY{n}{np}\PY{o}{.}\PY{n}{squeeze}\PY{p}{(}\PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}hat}\PY{p}{,} \PY{n}{y\PYZus{}tmp}\PY{p}{)}\PY{p}{)}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, expected:0.333}\PY{l+s+s2}{\PYZdq{}} \PY{p}{)}
\PY{n}{y\PYZus{}hat} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{]}\PY{p}{)}
\PY{n}{y\PYZus{}tmp} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{]}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{categorization error }\PY{l+s+si}{\PYZob{}}\PY{n}{np}\PY{o}{.}\PY{n}{squeeze}\PY{p}{(}\PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}hat}\PY{p}{,} \PY{n}{y\PYZus{}tmp}\PY{p}{)}\PY{p}{)}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, expected:0.250}\PY{l+s+s2}{\PYZdq{}} \PY{p}{)}

\PY{c+c1}{\PYZsh{} BEGIN UNIT TEST  }
\PY{n}{test\PYZus{}eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{)}
\PY{c+c1}{\PYZsh{} END UNIT TEST}
\PY{c+c1}{\PYZsh{} BEGIN UNIT TEST  }
\PY{n}{test\PYZus{}eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{)}
\PY{c+c1}{\PYZsh{} END UNIT TEST}
...
\PY{c+c1}{\PYZsh{} GRADED CELL: model}
\PY{k+kn}{import} \PY{n+nn}{logging}
\PY{n}{logging}\PY{o}{.}\PY{n}{getLogger}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{tensorflow}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{o}{.}\PY{n}{setLevel}\PY{p}{(}\PY{n}{logging}\PY{o}{.}\PY{n}{ERROR}\PY{p}{)}

\PY{n}{tf}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{set\PYZus{}seed}\PY{p}{(}\PY{l+m+mi}{1234}\PY{p}{)}
\PY{n}{model} \PY{o}{=} \PY{n}{Sequential}\PY{p}{(}
    \PY{p}{[}
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
        \PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{120}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{name} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{L1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{,}      
        \PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{40}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{name} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{L2}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{,}         
        \PY{n}{Dense}\PY{p}{(}\PY{n}{classes}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{linear}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{name} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{L3}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} 
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }

    \PY{p}{]}\PY{p}{,} \PY{n}{name}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Complex}\PY{l+s+s2}{\PYZdq{}}
\PY{p}{)}
...
\PY{n}{model\PYZus{}test}\PY{p}{(}\PY{n}{model}\PY{p}{,} \PY{n}{classes}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)} 
\PY{c+c1}{\PYZsh{} END UNIT TEST}
\end{Verbatim}
\end{tcolorbox}
...
\NormalTok{    [}
\NormalTok{        Dense(}\DecValTok{120}\NormalTok{, activation }\OperatorTok{=} \StringTok{\textquotesingle{}relu\textquotesingle{}}\NormalTok{, name }\OperatorTok{=} \StringTok{"L1"}\NormalTok{),      }
\NormalTok{        Dense(}\DecValTok{40}\NormalTok{, activation }\OperatorTok{=} \StringTok{\textquotesingle{}relu\textquotesingle{}}\NormalTok{, name }\OperatorTok{=} \StringTok{"L2"}\NormalTok{),         }
\NormalTok{        Dense(classes, activation }\OperatorTok{=} \StringTok{\textquotesingle{}linear\textquotesingle{}}\NormalTok{, name }\OperatorTok{=} \StringTok{"L3"}\NormalTok{)  }
\NormalTok{    ], name}\OperatorTok{=}\StringTok{"Complex"}
\NormalTok{)}
\NormalTok{model.}\BuiltInTok{compile}\NormalTok{(}
\NormalTok{    loss}\OperatorTok{=}\NormalTok{tf.keras.losses.SparseCategoricalCrossentropy(from\_logits}\OperatorTok{=}\VariableTok{True}\NormalTok{),          }
\NormalTok{    optimizer}\OperatorTok{=}\NormalTok{tf.keras.optimizers.Adam(}\FloatTok{0.01}\NormalTok{),   }
\NormalTok{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}make a model for plotting routines to call}
\PY{n}{model\PYZus{}predict} \PY{o}{=} \PY{k}{lambda} \PY{n}{Xl}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{softmax}\PY{p}{(}\PY{n}{model}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{Xl}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{numpy}\PY{p}{(}\PY{p}{)}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{plt\PYZus{}nn}\PY{p}{(}\PY{n}{model\PYZus{}predict}\PY{p}{,}\PY{n}{X\PYZus{}train}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{classes}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{suptitle}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Complex Model}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Canvas(toolbar=Toolbar(toolitems=[('Home', 'Reset original view', 'home', 'home'), ('Back', 'Back to previous …
    ...
    This model has worked very hard to capture outliers of each category. As
a result, it has miscategorized some of the cross-validation data. Let's
calculate the classification error.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{38}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{training\PYZus{}cerr\PYZus{}complex} \PY{o}{=} \PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{model\PYZus{}predict}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}\PY{p}{)}
\PY{n}{cv\PYZus{}cerr\PYZus{}complex} \PY{o}{=} \PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{model\PYZus{}predict}\PY{p}{(}\PY{n}{X\PYZus{}cv}\PY{p}{)}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{categorization error, training, complex model: }\PY{l+s+si}{\PYZob{}}\PY{n}{training\PYZus{}cerr\PYZus{}complex}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{categorization error, cv,       complex model: }\PY{l+s+si}{\PYZob{}}\PY{n}{cv\PYZus{}cerr\PYZus{}complex}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
categorization error, cv,       complex model: 0.122
    ...
    \#\#\# 5.1 Simple model Now, let's try a simple model

\#\#\# Exercise 4

Below, compose a two-layer model: * Dense layer with 6 units, relu
activation * Dense layer with 6 units and a linear activation. Compile
using * loss with \texttt{SparseCategoricalCrossentropy}, remember to
use \texttt{from\_logits=True} * Adam optimizer with learning rate of
0.01.
...
\PY{c+c1}{\PYZsh{} GRADED CELL: model\PYZus{}s}

\PY{n}{tf}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{set\PYZus{}seed}\PY{p}{(}\PY{l+m+mi}{1234}\PY{p}{)}
\PY{n}{model\PYZus{}s} \PY{o}{=} \PY{n}{Sequential}\PY{p}{(}
    \PY{p}{[}
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
        \PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{name}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{L1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{,}
        \PY{n}{Dense}\PY{p}{(}\PY{n}{classes}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{linear}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{name}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{L2}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
    \PY{p}{]}\PY{p}{,} \PY{n}{name} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Simple}\PY{l+s+s2}{\PYZdq{}}
\PY{p}{)}
\PY{n}{model\PYZus{}s}\PY{o}{.}\PY{n}{compile}\PY{p}{(}
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
    \PY{n}{loss}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{losses}\PY{o}{.}\PY{n}{SparseCategoricalCrossentropy}\PY{p}{(}\PY{n}{from\PYZus{}logits}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{,}
    \PY{n}{optimizer}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{optimizers}\PY{o}{.}\PY{n}{Adam}\PY{p}{(}\PY{l+m+mf}{0.01}\PY{p}{)}\PY{p}{,}
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
...
\PY{c+c1}{\PYZsh{} BEGIN UNIT TEST}
\PY{n}{model\PYZus{}s}\PY{o}{.}\PY{n}{fit}\PY{p}{(}
    \PY{n}{X\PYZus{}train}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{,}
    \PY{n}{epochs}\PY{o}{=}\PY{l+m+mi}{1000}
\PY{p}{)}
\PY{c+c1}{\PYZsh{} END UNIT TEST}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} BEGIN UNIT TEST}
\PY{n}{model\PYZus{}s}\PY{o}{.}\PY{n}{summary}\PY{p}{(}\PY{p}{)}

\PY{n}{model\PYZus{}s\PYZus{}test}\PY{p}{(}\PY{n}{model\PYZus{}s}\PY{p}{,} \PY{n}{classes}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
\PY{c+c1}{\PYZsh{} END UNIT TEST}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}make a model for plotting routines to call}
\PY{n}{model\PYZus{}predict\PYZus{}s} \PY{o}{=} \PY{k}{lambda} \PY{n}{Xl}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{softmax}\PY{p}{(}\PY{n}{model\PYZus{}s}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{Xl}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{numpy}\PY{p}{(}\PY{p}{)}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{plt\PYZus{}nn}\PY{p}{(}\PY{n}{model\PYZus{}predict\PYZus{}s}\PY{p}{,}\PY{n}{X\PYZus{}train}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{classes}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{suptitle}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Simple Model}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Canvas(toolbar=Toolbar(toolitems=[('Home', 'Reset original view', 'home', 'home'), ('Back', 'Back to previous …
    ...
    This simple models does pretty well. Let's calculate the classification
error.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{44}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{training\PYZus{}cerr\PYZus{}simple} \PY{o}{=} \PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{model\PYZus{}predict\PYZus{}s}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}\PY{p}{)}
\PY{n}{cv\PYZus{}cerr\PYZus{}simple} \PY{o}{=} \PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{model\PYZus{}predict\PYZus{}s}\PY{p}{(}\PY{n}{X\PYZus{}cv}\PY{p}{)}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{categorization error, training, simple model, }\PY{l+s+si}{\PYZob{}}\PY{n}{training\PYZus{}cerr\PYZus{}simple}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, complex model: }\PY{l+s+si}{\PYZob{}}\PY{n}{training\PYZus{}cerr\PYZus{}complex}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}} \PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{categorization error, cv,       simple model, }\PY{l+s+si}{\PYZob{}}\PY{n}{cv\PYZus{}cerr\PYZus{}simple}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, complex model: }\PY{l+s+si}{\PYZob{}}\PY{n}{cv\PYZus{}cerr\PYZus{}complex}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}} \PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{c+c1}{\PYZsh{} GRADED CELL: model\PYZus{}r}

\PY{n}{tf}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{set\PYZus{}seed}\PY{p}{(}\PY{l+m+mi}{1234}\PY{p}{)}
\PY{n}{model\PYZus{}r} \PY{o}{=} \PY{n}{Sequential}\PY{p}{(}
    \PY{p}{[}
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
        \PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{120}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{kernel\PYZus{}regularizer}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{regularizers}\PY{o}{.}\PY{n}{l2}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{)}\PY{p}{,} \PY{n}{name}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{L1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{,} 
        \PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{40}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{kernel\PYZus{}regularizer}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{regularizers}\PY{o}{.}\PY{n}{l2}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{)}\PY{p}{,} \PY{n}{name}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{L2}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{,}  
        \PY{n}{Dense}\PY{p}{(}\PY{n}{classes}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{linear}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{name}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{L3}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} 
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
    \PY{p}{]}\PY{p}{,} \PY{n}{name}\PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{ComplexRegularized}\PY{l+s+s2}{\PYZdq{}}
\PY{p}{)}
\PY{n}{model\PYZus{}r}\PY{o}{.}\PY{n}{compile}\PY{p}{(}
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
    \PY{n}{loss}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{losses}\PY{o}{.}\PY{n}{SparseCategoricalCrossentropy}\PY{p}{(}\PY{n}{from\PYZus{}logits}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{,}
    \PY{n}{optimizer}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{optimizers}\PY{o}{.}\PY{n}{Adam}\PY{p}{(}\PY{l+m+mf}{0.01}\PY{p}{)}\PY{p}{,}
    \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} }
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} BEGIN UNIT TEST}
\PY{n}{model\PYZus{}r}\PY{o}{.}\PY{n}{fit}\PY{p}{(}
    \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,}
    \PY{n}{epochs}\PY{o}{=}\PY{l+m+mi}{1000}
\PY{p}{)}
\PY{c+c1}{\PYZsh{} END UNIT TEST}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} BEGIN UNIT TEST}
\PY{n}{model\PYZus{}r}\PY{o}{.}\PY{n}{summary}\PY{p}{(}\PY{p}{)}

\PY{n}{model\PYZus{}r\PYZus{}test}\PY{p}{(}\PY{n}{model\PYZus{}r}\PY{p}{,} \PY{n}{classes}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)} 
\PY{c+c1}{\PYZsh{} END UNIT TEST}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Highlighting}[]
\NormalTok{tf.random.set\_seed(}\DecValTok{1234}\NormalTok{)}
\NormalTok{model\_r }\OperatorTok{=}\NormalTok{ Sequential(}
\NormalTok{    [}
\NormalTok{        Dense(}\DecValTok{120}\NormalTok{, activation }\OperatorTok{=} \StringTok{\textquotesingle{}relu\textquotesingle{}}\NormalTok{, kernel\_regularizer}\OperatorTok{=}\NormalTok{tf.keras.regularizers.l2(}\FloatTok{0.1}\NormalTok{), name}\OperatorTok{=}\StringTok{"L1"}\NormalTok{), }
\NormalTok{        Dense(}\DecValTok{40}\NormalTok{, activation }\OperatorTok{=} \StringTok{\textquotesingle{}relu\textquotesingle{}}\NormalTok{, kernel\_regularizer}\OperatorTok{=}\NormalTok{tf.keras.regularizers.l2(}\FloatTok{0.1}\NormalTok{), name}\OperatorTok{=}\StringTok{"L2"}\NormalTok{),  }
\NormalTok{        Dense(classes, activation }\OperatorTok{=} \StringTok{\textquotesingle{}linear\textquotesingle{}}\NormalTok{, name}\OperatorTok{=}\StringTok{"L3"}\NormalTok{)  }
\NormalTok{    ], name}\OperatorTok{=}\StringTok{"ComplexRegularized"}
\NormalTok{)}
\NormalTok{model\_r.}\BuiltInTok{compile}\NormalTok{(}
\NormalTok{    loss}\OperatorTok{=}\NormalTok{tf.keras.losses.SparseCategoricalCrossentropy(from\_logits}\OperatorTok{=}\VariableTok{True}\NormalTok{), }
\NormalTok{    optimizer}\OperatorTok{=}\NormalTok{tf.keras.optimizers.Adam(}\FloatTok{0.01}\NormalTok{),                             }
\NormalTok{)}

\NormalTok{model\_r.fit(}
\NormalTok{    X\_train,y\_train,}
\NormalTok{    epochs}\OperatorTok{=}\DecValTok{1000}
\NormalTok{)                                   }
\end{Highlighting}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}make a model for plotting routines to call}
\PY{n}{model\PYZus{}predict\PYZus{}r} \PY{o}{=} \PY{k}{lambda} \PY{n}{Xl}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{softmax}\PY{p}{(}\PY{n}{model\PYZus{}r}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{Xl}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{numpy}\PY{p}{(}\PY{p}{)}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
 
\PY{n}{plt\PYZus{}nn}\PY{p}{(}\PY{n}{model\PYZus{}predict\PYZus{}r}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{classes}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{suptitle}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Regularized}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Canvas(toolbar=Toolbar(toolitems=[('Home', 'Reset original view', 'home', 'home'), ('Back', 'Back to previous …
    ...
    The results look very similar to the `ideal' model. Let's check
classification error.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{49}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{training\PYZus{}cerr\PYZus{}reg} \PY{o}{=} \PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{model\PYZus{}predict\PYZus{}r}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}\PY{p}{)}
\PY{n}{cv\PYZus{}cerr\PYZus{}reg} \PY{o}{=} \PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}cv}\PY{p}{,} \PY{n}{model\PYZus{}predict\PYZus{}r}\PY{p}{(}\PY{n}{X\PYZus{}cv}\PY{p}{)}\PY{p}{)}
\PY{n}{test\PYZus{}cerr\PYZus{}reg} \PY{o}{=} \PY{n}{eval\PYZus{}cat\PYZus{}err}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{model\PYZus{}predict\PYZus{}r}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{)}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{categorization error, training, regularized: }\PY{l+s+si}{\PYZob{}}\PY{n}{training\PYZus{}cerr\PYZus{}reg}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, simple model, }\PY{l+s+si}{\PYZob{}}\PY{n}{training\PYZus{}cerr\PYZus{}simple}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, complex model: }\PY{l+s+si}{\PYZob{}}\PY{n}{training\PYZus{}cerr\PYZus{}complex}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}} \PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{categorization error, cv,       regularized: }\PY{l+s+si}{\PYZob{}}\PY{n}{cv\PYZus{}cerr\PYZus{}reg}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, simple model, }\PY{l+s+si}{\PYZob{}}\PY{n}{cv\PYZus{}cerr\PYZus{}simple}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, complex model: }\PY{l+s+si}{\PYZob{}}\PY{n}{cv\PYZus{}cerr\PYZus{}complex}\PY{l+s+si}{:}\PY{l+s+s2}{0.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}} \PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
categorization error, training, regularized: 0.072, simple model, 0.062, complex
model: 0.003
categorization error, cv,       regularized: 0.066, simple model, 0.087, complex
model: 0.122
    \end{Verbatim}

    The simple model is a bit better in the training set than the
regularized model but it worse in the cross validation set.

    \#\# 7 - Iterate to find optimal regularization value As you did in
linear regression, you can try many regularization values. This code
takes several minutes to run. If you have time, you can run it and check
the results. If not, you have completed the graded parts of the
assignment!
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{tf}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{set\PYZus{}seed}\PY{p}{(}\PY{l+m+mi}{1234}\PY{p}{)}
\PY{n}{lambdas} \PY{o}{=} \PY{p}{[}\PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.001}\PY{p}{,} \PY{l+m+mf}{0.01}\PY{p}{,} \PY{l+m+mf}{0.05}\PY{p}{,} \PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mf}{0.2}\PY{p}{,} \PY{l+m+mf}{0.3}\PY{p}{]}
\PY{n}{models}\PY{o}{=}\PY{p}{[}\PY{k+kc}{None}\PY{p}{]} \PY{o}{*} \PY{n+nb}{len}\PY{p}{(}\PY{n}{lambdas}\PY{p}{)}
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{lambdas}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    \PY{n}{lambda\PYZus{}} \PY{o}{=} \PY{n}{lambdas}\PY{p}{[}\PY{n}{i}\PY{p}{]}
    \PY{n}{models}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=}  \PY{n}{Sequential}\PY{p}{(}
        \PY{p}{[}
            \PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{120}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{kernel\PYZus{}regularizer}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{regularizers}\PY{o}{.}\PY{n}{l2}\PY{p}{(}\PY{n}{lambda\PYZus{}}\PY{p}{)}\PY{p}{)}\PY{p}{,}
            \PY{n}{Dense}\PY{p}{(}\PY{l+m+mi}{40}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{relu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{kernel\PYZus{}regularizer}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{regularizers}\PY{o}{.}\PY{n}{l2}\PY{p}{(}\PY{n}{lambda\PYZus{}}\PY{p}{)}\PY{p}{)}\PY{p}{,}
            \PY{n}{Dense}\PY{p}{(}\PY{n}{classes}\PY{p}{,} \PY{n}{activation} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{linear}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{p}{]}
    \PY{p}{)}
    \PY{n}{models}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{compile}\PY{p}{(}
        \PY{n}{loss}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{losses}\PY{o}{.}\PY{n}{SparseCategoricalCrossentropy}\PY{p}{(}\PY{n}{from\PYZus{}logits}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{,}
        \PY{n}{optimizer}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{optimizers}\PY{o}{.}\PY{n}{Adam}\PY{p}{(}\PY{l+m+mf}{0.01}\PY{p}{)}\PY{p}{,}
    \PY{p}{)}

    \PY{n}{models}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{fit}\PY{p}{(}
        \PY{n}{X\PYZus{}train}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{,}
        \PY{n}{epochs}\PY{o}{=}\PY{l+m+mi}{1000}
    \PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Finished lambda = }\PY{l+s+si}{\PYZob{}}\PY{n}{lambda\PYZus{}}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{plot\PYZus{}iterate}\PY{p}{(}\PY{n}{lambdas}\PY{p}{,} \PY{n}{models}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}cv}\PY{p}{,} \PY{n}{y\PYZus{}cv}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Canvas(toolbar=Toolbar(toolitems=[('Home', 'Reset original view', 'home', 'home'), ('Back', 'Back to previous …
    ...
    As regularization is increased, the performance of the model on the
training and cross-validation data sets converge. For this data set and
model, lambda \textgreater{} 0.01 seems to be a reasonable choice.

    \#\#\# 7.1 Test Let's try our optimized models on the test set and
compare them to `ideal' performance.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{54}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{plt\PYZus{}compare}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{classes}\PY{p}{,} \PY{n}{model\PYZus{}predict\PYZus{}s}\PY{p}{,} \PY{n}{model\PYZus{}predict\PYZus{}r}\PY{p}{,} \PY{n}{centers}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Canvas(toolbar=Toolbar(toolitems=[('Home', 'Reset original view', 'home', 'home'), ('Back', 'Back to previous …
    ...
    Our test set is small and seems to have a number of outliers so
classification error is high. However, the performance of our optimized
models is comparable to ideal performance.
